...
export default function OrganizationsAdminPage() {
  ...
  return (
    <div className="w-full space-y-5">
      ...
      {/* 2. Search & Filter Bar with Unit Count */}
      <div className="rounded-2xl border border-slate-200/90 bg-white p-4 sm:p-4.5 shadow-sm flex flex-col sm:flex-row items-center justify-between gap-3">
        ...
        <div className="flex items-center space-x-3 text-xs w-full sm:w-auto justify-between sm:justify-end">
          {/* Small Unit Count Badge */}
          <div className="inline-flex items-center space-x-1.5 rounded-full bg-slate-100 border border-slate-200/80 px-3 py-1.5 text-xs text-slate-600 font-medium">
            <span className="text-slate-500">Số lượng:</span>
            <span className="font-bold text-slate-900">{organizations.length}</span>
