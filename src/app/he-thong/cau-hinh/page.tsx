...
export default function SystemConfigPage() {
  ...
  return (
    <div className="w-full space-y-6">
      ...
      {activeTab === 'software' && (
        <div className="space-y-6">
          {/* Top Hero & Release Action (2 cols Left - 1 col Right) */}
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            
            {/* 1. Software Info Form (Left - 2 Cols) */}
            ...
            {/* 2. Version Hero & Release Action (Right - 1 Col) */}
            <div
            ...
            >
              <div>
                <div className="flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-slate-500 font-medium">Bản phát hành chính thức</span>
                </div>
              ...
              <div className="mt-5 space-y-3 pt-3 border-t border-slate-200">
                <button
                  type="button"
                  onClick={() => {
                  ...
                  style={{ backgroundColor: currentBrandColor }}
                  className="w-full inline-flex items-center justify-center space-x-1.5 rounded-full px-4 py-2 text-xs font-bold text-white shadow-sm hover:opacity-90 transition-all cursor-pointer"
                >
                  <Plus className="h-4 w-4" />
                  <span>Phát Hành Phiên Bản Mới</span>
                </button>

                <p className="text-[11px] text-slate-500 truncate text-center">
                  Bản quyền: <span className="font-semibold text-slate-700">{config.softwareInfo.developer}</span>
                </p>
              </div>
            </div>
